...
$str_out .= '
	        	...
	        	<div class="col-sm-12" id="mancatacontestazione">
					...
					<div class="col-sm-8 BoxRowCaption add_text">
                        ...
                        <div class="col-sm-11">
                            <span id="reason"></span>
                            <select class="form-control frm_field_required" name="ReasonId" id="ReasonId">
                            </select>
                        </div>
                        <input type="hidden" id="itsreason" value="reason">
                        <div class="col-sm-11">
                            <input name="Reason_Text" id="Reason_Text" type="text" class="form-control frm_field_string frm_field_required" style="display: none">
                        </div>
                    </div>
    ...
    $('document').ready(function () {
        $('#NotificationType').change(function () {
            if($(this).val()==2){
                ...
                $('#Reason_Text').removeClass('frm_field_required');
                $('#ReasonId').append("<option></option>");
            } else {
                $('#ReasonId').addClass('frm_field_required');
                $('#Reason_Text').addClass('frm_field_required');
            }
        });
