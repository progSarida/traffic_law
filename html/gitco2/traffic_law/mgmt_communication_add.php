...
$rs_Trespasser = $rs->Select('V_FineTrespasser',"FineId=".$Id." AND (TrespasserTypeId=1 OR TrespasserTypeId=2 OR TrespasserTypeId=10)","TrespasserTypeId");
...
$str_Rent = '';
if($r_Trespasser['TrespasserTypeId']==10){
    $str_Rent ='
    ...
    ';
    $rs_Trespasser = $rs->Select('V_FineTrespasser',"FineId=".$Id." AND TrespasserTypeId=11","TrespasserTypeId");
    $r_Trespasser = mysqli_fetch_array($rs_Trespasser);
}

$str_DocumentFolder = ($r_Trespasser['CountryId']=='Z000') ? NATIONAL_FINE_HTML."/".$_SESSION['cityid']."/". $Id ."/": FOREIGN_FINE_HTML."/".$_SESSION['cityid']."/".$Id ."/";

$b_hasDoc = false;
$str_CommunicationFile = '';

$rs_Documentation = $rs->Select('FineDocumentation', "FineId=" . $Id." AND DocumentationTypeId=20", "DocumentationTypeId");
...
$communicationDateDefault='';
$notificationDate_rs =$rs->Select("FineHistory", "notificationTypeId=6 and FineId='$Id' and FineId in (select FineId from FineTrespasser where FineNotificationType=1)");
if($notificatDateRow = mysqli_fetch_array($notificationDate_rs))
    $communicationDateDefault=DateOutDB($notificatDateRow['NotificationDate']);
$DocumentCountryId = (trim($r_Trespasser['DocumentCountryId'])=="") ? "Z000" : $r_Trespasser['DocumentCountryId'];

$str_out .='
    	<div class="col-sm-12">
        	<div class="col-sm-6">
        	<form name="f_comm_ins" id="f_comm_ins" action="mgmt_communication_add_exe.php'.$str_GET_Parameter.'" method="post">
                ...
                <input type="hidden" name="FineCommunicationId" value="'.$Id.'">
        	    ...
        	    <div class="col-sm-12">
                    ...
                    <div class="col-sm-3 BoxRowCaption">
                        <input class="form-control frm_field_date frm_field_required" type="text" name="CommunicationDate"  style="width:12rem" value="'.$communicationDateDefault.'" />
                    </div>
                    <div class="col-sm-2 BoxRowLabel">
                        Protocollo n°
                    </div>
                    <div class="col-sm-4 BoxRowCaption">
                        <input class="form-control frm_field_string" type="text" name="CommunicationProtocol" value="" />
                    </div>
                    ...
                    <div class="col-sm-1 BoxRowCaption">
                        <input type="checkbox" id="CheckIncomplete" name="CheckIncomplete" value="1" />
                    </div>
                    <div class="col-sm-8 BoxRowCaption">
                        '.CreateArraySelect($a_IncompleteCommunication, true, 'Incomplete', 'Incomplete', 1, true, null, 'hidden').'
                    </div>

                    <div class="clean_row HSpace16"></div>

                    <div class="col-sm-12 BoxRowLabel BoxRowTitle">
                        <input type="radio" name="TrespasserTypeId" value="1" CHECKED> Proprietario/Trasgressore &nbsp;
                        <input type="radio" name="TrespasserTypeId" value="2"> Proprietario/Obbligato in solido (inserimento trasgressore)
                    </div>
...
if($r_Trespasser['Genre'] != 'D' || ($r_Trespasser['Genre'] == 'D' && in_array($r_Trespasser['LegalFormId'], $a_LegalFormIndividual))){
                    $str_out.= '
                        ...
                        <div class="col-sm-4 BoxRowCaption">
                        ' . CreateSelect("Country",null,"Title","DocumentCountryId","Id","Title",$DocumentCountryId,false,"","") .'
                        </div>
                    ...
                    $str_out.= '
                        ...
                        <div class="col-sm-3 BoxRowCaption">
                            '.(!is_null($r_Trespasser['FineNotificationType']) ? $NotificationType[$r_Trespasser['FineNotificationType']] : '').'
                        </div>
                        <div class="col-sm-3 BoxRowLabel">
                            Data notifica
                        </div>
...
if($r_Trespasser['Genre'] != 'D' || ($r_Trespasser['Genre'] == 'D' && in_array($r_Trespasser['LegalFormId'], $a_LegalFormIndividual))){
  				...
  				<div id="othertrespasser" class="alert alert-info col-sm-12" style="display: none;">		
                    <div class="col-sm-12">
                        <div class="col-sm-6 BoxRowLabel" style="background-color:#294A9C;">
                            TRASGRESSORE:
                        </div>
                        ...
                        <div class="tab-pane active" id="Trespasser">
                            <div class="row-fluid">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-3 BoxRowCaption">
                                        <input class="form-control frm_field_string" type="text" name="Surname_S" id="Surname_S">
                                    </div>
                                    <div class="col-sm-3 BoxRowLabel">
                                        Nome
                                    </div>
                                    <div class="col-sm-3 BoxRowCaption">
                                        <input class="form-control frm_field_string" type="text" name="Name_S" id="Name_S">
                                    </div>
                                    <div class="clean_row HSpace4"></div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4 BoxRowCaption">
                        ' . CreateSelect("Country",null,"Title","DocumentCountryIdDriver","Id","Title","Z000",true,"","") .'
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4 BoxRowCaption">
                            <input class="form-control frm_field_date frm_field_required" type="text" name="LicenseDateDriver" id="LicenseDateDriver"  style="width:12rem" value="" />
                        </div>
                        <div class="col-sm-2 BoxRowLabel">
                            Ente rilascio
                        </div>
                        <div class="col-sm-4 BoxRowCaption">
                            <input class="form-control frm_field_string frm_field_required" type="text" id="LicenseOfficeDriver" name="LicenseOfficeDriver" style="width:18rem" value="" />
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4 BoxRowCaption">
                            <input class="form-control frm_field_string frm_field_required" type="text" id="LicenseCategoryDriver" name="LicenseCategoryDriver"  style="width:10rem" value="" />
                        </div>
                        <div class="col-sm-2 BoxRowLabel">
                            Numero
                        </div>
                        <div class="col-sm-4 BoxRowCaption">
                            <input class="form-control frm_field_string frm_field_required" type="text" id="LicenseNumberDriver" name="LicenseNumberDriver"  style="width:10rem" value="" />
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	function toggleRequiredFields(radioVal){
		$('#f_comm_ins').data('bootstrapValidator').resetForm();
		if(radioVal == 1){
			if(checkDocumentType($('#DocumentTypeId'))){
				$("#f_comm_ins").bootstrapValidator('addField', $('#LicenseDateMain, #LicenseCategoryMain, #LicenseNumberMain, #LicenseOfficeMain'));
				$("#f_comm_ins").bootstrapValidator('removeField', $('#LicenseDateDriver, #LicenseCategoryDriver, #LicenseNumberDriver, #LicenseOfficeDriver'));
			...
			if(checkDocumentType($('#DocumentTypeIdDriver'))){
				$("#f_comm_ins").bootstrapValidator('removeField', $('#LicenseDateMain, #LicenseCategoryMain, #LicenseNumberMain, #LicenseOfficeMain'));
				$("#f_comm_ins").bootstrapValidator('addField', $('#LicenseDateDriver, #LicenseCategoryDriver, #LicenseNumberDriver, #LicenseOfficeDriver'));
			...
			$("#f_comm_ins").bootstrapValidator('removeField', $('#LicenseDateMain, #LicenseCategoryMain, #LicenseNumberMain, #LicenseOfficeMain, #LicenseDateDriver, #LicenseCategoryDriver, #LicenseNumberDriver, #LicenseOfficeDriver'));
