...
$str_out .= '
        <form name="f_violation" id="f_violation" method="post" action="mgmt_violation_exp_exe.php">
...
$str_out .= '													
        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-12 BoxRow" style="width:100%;height:60.2rem;">
                <div class="imgWrapper" style="height:60.2rem;overflow:auto">
        ...
        <div class="col-sm-12">
            <div class="col-sm-12 BoxRow" style="height:6rem;">
                <div class="col-sm-12" style="text-align:center;line-height:6rem;">
                    ...
                    <button class="btn btn-default" id="delete">Archivia</button>
    ...
    <script type="text/javascript">
        $('document').ready(function(){
            ...
            $('#f_violation').submit(function() {
                if(del){
                    var c = confirm("Si sta per archiviare il verbale in maniera definitiva. Continuare?");
                    return c;
                }
            });
