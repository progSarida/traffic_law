...
function pieChart_f() {
  ...
  function init() {
    ...
    canvas = document.getElementById('chart_f');
  ...
  function startPullOut ( slice ) {
    ...
    $('#chartData_f td').removeClass('highlight');
    var labelCell = $('#chartData_f td:eq(' + (slice*2) + ')');
    var valueCell = $('#chartData_f td:eq(' + (slice*2+1) + ')');
