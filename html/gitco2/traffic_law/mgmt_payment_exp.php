...
if(mysqli_num_rows($rs_Payment)>0){
    ...
    $str_Fine = '
            ...
            <form id="f_payment" action="mgmt_payment_exp_exe.php">
            <input type="hidden" name="RefundStatus" value="1">
            <input type="hidden" name="PaymentId" value="'.$PaymentId.'">
            <input type="hidden" name="FineId" value="'.$FineId.'">
            <input type="hidden" name="Filters" value="'.$str_GET_Parameter.'">
            
            <div class="col-sm-12 BoxRow" style="height:10rem">
                <div class="col-sm-2 BoxRowLabel" >
                    Data rimborso
                </div>
                <div class="col-sm-1 BoxRowCaption">
                   <input type="text" id="RefundDate" name="RefundDate" style="width:10rem;">		
                ...
                <div class="col-sm-1 BoxRowCaption">
                   <input type="text" id="Amount" name="Amount" value="'.$r_Payment['Amount'].'" style="width:10rem;">		
                ...
                <div class="col-sm-6 BoxRowCaption">	
                    <textarea name="Note"  style="width:60rem;height:8rem"></textarea>	
                </div>					
            </div>  
  		</div>	     	
        <div class="col-sm-12">
            <div class="col-sm-12 BoxRow" style="height:6rem;">
                ...
                <div class="col-sm-12 BoxRowLabel" style="text-align:center;line-height:6rem;">
                    <input type="submit" class="btn btn-default" value="Salva" style="margin-top:1rem;">
    ...
    $('document').ready(function(){
        ...
        $('#f_payment').bootstrapValidator({
            ...
            fields: {
                Amount : {
                    validators: {
                        notEmpty: {message: 'Importo obbligatorio'},
