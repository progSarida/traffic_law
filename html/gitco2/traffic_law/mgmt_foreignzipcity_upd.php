...
<div class="container" id="add_new_zipcity">
    ...
    $zipcity = $rs->SelectQuery("
        ...
        WHERE sarida.ForeignZIPCity.Id =$zipcity_id");
    $zipaddress = $rs->SelectQuery("SELECT * FROM sarida.ForeignZIPAddress where sarida.ForeignZIPAddress.ZIPCityId =$zipcity_id");
    ...
    <form class="form" action="mgmt_foreignzipcity_add_exe.php" method="post">
        ...
        <div class="form-group col-lg-3">
            ...
            <select class="form-control" name="city_id" required>
                ...
                <?php
                $selected = "";
                $city = $rs->SelectQuery("SELECT Id,Title FROM traffic_law.ForeignCity"); 
