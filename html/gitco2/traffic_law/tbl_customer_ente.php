...
if ($RowNumber == 0) {
    ...
    while ($customer = mysqli_fetch_array($customers)) {
        ...
        $str_out.= '
            ...
            '.ChkButton($aUserButton, 'viw','<a href="tbl_customer_ente_viw.php?CityId=' . $customer['CityId'] . '&PageTitle=Gestione/Customer""><span class="glyphicon glyphicon-eye-open" style="left:25px;top:5px;"></span></a>').'
            
            '.ChkButton($aUserButton, 'upd','<a href="tbl_customer_ente_upd.php?Id=' . $customer['CityId'] . '&tab=1&PageTitle=Gestione/Customer"><span class="glyphicon glyphicon-pencil" style="left:25px;top:5px;"></span></a>').'
