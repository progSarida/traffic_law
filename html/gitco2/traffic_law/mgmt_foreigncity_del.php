...
$str_out .='
    <div class="col-sm-12">
        <form name="f_foreigncity_del" id="f_foreigncity_del" action="mgmt_foreigncity_del_exe.php'.$str_GET_Parameter.'" method="post">
            ...
            <div class="col-sm-12 BoxRow" style="height:6rem;">
                <div class="col-sm-12 " style="text-align:center;line-height:6rem;">
                    ...
                    <input type="button" id="back" value="Indietro" class="btn btn-default">
                </div>
            </div>
        </form>
    </div>';
...
$(document).ready(function () {
    ...
    $('#Delete').on("click", function(event){
        ...
        setTimeout(function(){
        	if (confirm('Si sta per cancellare questo comune straniero in maniera definitiva. Continuare?')) {
        		if (confirm('Sei veramente sicuro di voler continuare?')) {
        			$("#f_foreigncity_del").submit();
        		} else return false;
        	} else return false;
        }, 500);
    });
