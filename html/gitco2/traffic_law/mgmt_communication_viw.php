...
$rs_Trespasser = $rs->Select('V_TrespasserCommunication', "FineId=" . $FineId); //tolte le condizioni sul tipo di trasgressore caricato che erano 
...
$str_Folder = ($r_Trespasser['CountryId']=='Z000') ? 'doc/national/fine' : 'doc/foreign/fine';

$str_tree = "";
$str_Img = "";
$doc_rows = $rs->Select('FineDocumentation',"FineId=" . $r_Trespasser['FineId']." AND DocumentationTypeId=20", "Id");
...
if ($doc_n > 0)
  {
    ...
    $File = $str_Folder.'/'.$_SESSION['cityid'].'/'.$r_Trespasser['FineId'].'/'.$doc_row['Documentation'];
...
';
    ...
    $str_tree ='
        $("#fileTreeDemo_1").fileTree({ root:\''.$str_Folder.'/'.$_SESSION['cityid'].'/'.$r_Trespasser['FineId'].'/\', script: \'jqueryFileTree.php\' }, function(file) {
    ...
    $str_Documentation .='
        <div class="col-sm-6">
            ...
            <div class="col-sm-8 table_caption_H">
                '. $doc_row['Documentation'] .'	
            </div>
            <div class="col-sm-12 BoxRow" style="width:100%;height:9rem;">
                <div class="example">
                    <div id="fileTreeDemo_1" class="BoxRowLabel" style="height:8rem;overflow:auto"></div>
                </div>
            </div>
            <div class="col-sm-12 BoxRow" style="width:100%;height:40rem;">
                <div class="imgWrapper" id="preview_img" style="display: none; height:38rem;overflow:auto">
                    <img id="preview" class="iZoom"  />
                </div>
                <div id="preview_doc" style="height:38rem;overflow:auto; display: none;"></div>   
            </div>
        </div>    
    ';
...
if ($r_Trespasser['OwnerTypeId'] == 2)
  ...
  $str_out .= '<div class="alert alert-info col-sm-12">
