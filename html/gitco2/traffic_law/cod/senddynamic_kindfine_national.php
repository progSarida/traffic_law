...
$DocumentTypeId = 15; //bonario traffic_law.Document_Type
...
if(isset($_POST['check'])) {
    ...
    if($ultimate){
        ...
        $FileName = "Flusso_".$int_FlowNumber."_BONARIO_Ita_".$_SESSION['cityid']."_".date("Y-m-d")."_".date("H-i-s")."_".count($_POST['check']);
    } else {
        $FileName = "Flusso_BONARIO_Ita_".$_SESSION['cityid']."_PROVVISORIO";
    }
    ...
    foreach ($_POST['check'] as $FineId){
        ...
        while($r_Fine = mysqli_fetch_array($rs_Fine)){
            ...
            if($CreationType==5){
                ...
                //per il pagamento oltre i 5 gg se voranno indicarlo per il secondo Iuv
                //Ipotizzando di dover addebitare spese di ricerca e notifica (o forfettarie) + i due euro dell'invio bonario
            ...
            //Spese di notifica dell'avviso bonario
            $AdditionalFee += $KindFee;
            ...
            //Fine/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            $PaymentDays = $r_Customer['PaymentDaysNational'];
            if ($r_ArticleTariff['ReducedPayment']) {
                $str_PaymentDay1 = "Pagamento entro $PaymentDays gg dalla notif.";
                $str_PaymentDay2 = "Pagamento dopo  $PaymentDays gg ed entro 60gg dalla notif.";
                
            } else {
                $str_PaymentDay1 = "Pagamento entro $PaymentDays gg dalla notif.";
                $str_PaymentDay2 = "Pagamento dopo $PaymentDays gg ed entro 6 mesi dalla notif.";
            }
            ...
            $Content = str_replace("{ManagerMail}", $r_Customer['ManagerMail'] ? 'MAIL: '.$r_Customer['ManagerMail'] : '', $Content);$Content = str_replace("{ManagerPEC}", $r_Customer['ManagerPEC'], $Content);
            ...
            if ($ultimate) {
                ...
                //DA FARE: se il verbale originale è dell'anno precedente assegnare ProtocolYear del verbale originale
...
//         	    }
            ...
            if ($b_PrintBill && $FormTypeId!=101) {
                ...
                $flt_Amount = $chk_ReducedPayment ? $TotalPartialFee : $TotalFee;
                ...
                $flt_Amount = $chk_ReducedPayment ? $TotalFee : $TotalMaxFee;
                
                //rimozione secondo bollettino
                /*
                ...
                if ($r_Customer['NationalPostalAuthorization'] != "") {
                    $pdf->autorizzazione_bollettino($r_Customer['NationalPostalAuthorization'], 'due');
