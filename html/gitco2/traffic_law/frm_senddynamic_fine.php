...
$str_out .='        
		...
		<div class="table_caption_H col-sm-12 alert-warning">
            <i class="fas fa-fw fa-info-circle col-sm-1" style="margin-top: 0.5rem;"></i>&nbsp;&nbsp;&nbsp;Nota: la procedura e correntemente limitata a restituire un numero massimo di '.SENDDYNAMICFINE_LIMIT.' atti elaborabili.
        </div>

    	<form id="f_search" action="frm_senddynamic_fine.php" method="post" autocomplete="off">
    	...
    	<form name="f_print" id="f_print" action="frm_senddynamic_fine_exe.php" method="post">
...
if($s_TypePlate==""){
    ...
    $table_rows = $rs->SelectQuery($cls_view->generateSelect($str_Where, null, $strOrder, SENDDYNAMICFINE_LIMIT));
