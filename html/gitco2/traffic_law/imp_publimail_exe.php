...
if(isset($_POST['Extract'])){
    ...
    //******************************************
    //DA ADATTARE TUTTA LA STRUTTURA DELLA VERA IMPORTAZIONE
    //******************************************
    $LeasingDocTypeId = 43;
...
//////////////////CONTROLLO DATI
                ...
                if(!empty($data['NumeroProtocollo'])){
                    ...
                    if(preg_match(IMP_PUBLIMAIL_FULLPROTOCOL_RGX, $FullProtocol)){
...
//////////////////INSERIMENTO DATI
                ...
                if ($FineId == 0) {
                    ...
                    header("location: ".impostaParametriUrl(array('ImportFile' => $ImportFile), "imp_publimail.php"));
                    DIE;
                }
...
header("location: imp_publimail.php".$Filters);
