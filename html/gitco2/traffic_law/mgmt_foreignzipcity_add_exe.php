...
if (isset($_POST['submit'])){    
    ...
    if ($nr > 6) {
        ...
        header("Location: mgmt_foreignzipcity.php?PageTitle=Gestione/Zipcity Estero&answer=Inserito con successo!");
    }
    ...
    $update = $rs->Update('sarida.ForeignZIPCity', $a_ZipCity,"Id='".$ZipcityId."'");
    ...
    if (isset($_POST['type'])&& isset($_POST['from'])&& isset($_POST['zip'])){
        ...
        if(isset($exist)){
            ...
            for($i=0;$i<count($exist);$i++){
                ...
                $update = $rs->Update('sarida.ForeignZIPAddress',$a_ZipAdress,"Id='".$exist[$i]."'");
        ...
        if($exist==null) $i=0;
            ...
            for(;$i<count($type);$i++){
                ...
                $insert =$rs->Insert('sarida.ForeignZIPAddress',$a_ZipAdress);
    ...
    header("Location: mgmt_foreignzipcity.php?PageTitle=Gestione/Zipcity Estero&answer=Aggiornato con successo");
}