...
$submitBtnType = "addMainMenu";
$submitBtnName = "add";


$allItems = $obj->Select( "MainMenu" ); //Getting all main menu items
...
$showItems = $obj->Select( "MainMenu" , $whereClause=null, $orderBy=null, $limit ); //Getting all main menu items under limit

if( isset( $_GET['edit'] ) ){
	$editItem = $obj->Select( "MainMenu", "Id=".$_GET['edit'] ); //For editting a particular row	
	//Putting values for update data
	$fieldValue = array( 
						0=>$editItem[0]['Description'],
						1=>$editItem[0]['Path'],
						2=>$editItem[0]['Disabled'],
						3=>$editItem[0]['Id']
					);
	$submitBtnType = "updateMainMenu";
			...
			<div class="panel panel-flat">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" name="mainMenu[]" class="form-control" value="<?php echo $fieldValue[0]; ?>" placeholder="Enter Description" required >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" name="mainMenu[]" class="form-control" value="<?php echo $fieldValue[1]; ?>" placeholder="Enter Path" required >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<label class="radio-inline">
								<input type="radio" name="mainMenu[]" class="styled" value="1" <?php if(isset($fieldValue[2]) && $fieldValue[2]==1){ ?> checked="checked" <?php }else{ ?> checked="checked" <?php } ?> >
								Yes
							</label>
							<label class="radio-inline">
								<input type="radio" name="mainMenu[]" class="styled" value="0" <?php if(isset($fieldValue[2]) && $fieldValue[2]==0){ ?> checked="checked" <?php } ?> >
								No
							</label>
						</div>
					</div>
					...
					<div class="text-right">
						<input type="hidden" name="mainMenu[id]" value="<?php echo $fieldValue[3]; ?>">
		...
		<div class="panel panel-flat">
			...
			<table class="table datatable-basic">
				...
				?>
					<tr>
						<td>
							<a target="_blank" href="<?php echo PATH . $eachMenuItem['Path']; ?>">
							...
							<ul class="icons-list">
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li>
											<a href="<?php echo "class/lib.php?deleteMainMenu=" . $eachMenuItem['Id']; ?>" onclick="return confirm('Sure To Delete?');">
